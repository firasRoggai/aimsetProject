...
const SignIn = (props) => {
  return /* @__PURE__ */ import_react.default.createElement(import_clerk_react.SignIn, { ...(0, import_useEnforceRoutingProps.useEnforceCorrectRoutingProps)("SignIn", props) });
};
const SignUp = (props) => {
  return /* @__PURE__ */ import_react.default.createElement(import_clerk_react.SignUp, { ...(0, import_useEnforceRoutingProps.useEnforceCorrectRoutingProps)("SignUp", props) });
};
