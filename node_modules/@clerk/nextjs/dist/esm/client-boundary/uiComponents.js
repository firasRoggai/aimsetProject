...
const SignIn = (props) => {
  return /* @__PURE__ */ React.createElement(BaseSignIn, { ...useEnforceCorrectRoutingProps("SignIn", props) });
};
const SignUp = (props) => {
  return /* @__PURE__ */ React.createElement(BaseSignUp, { ...useEnforceCorrectRoutingProps("SignUp", props) });
};
export {
  CreateOrganization,
  OrganizationList,
